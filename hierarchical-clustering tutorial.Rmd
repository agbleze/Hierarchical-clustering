...
In order to do a little deep dive, we will take them in turns. This tutorial will focus on hierarchical clustering 



In  Sometimes, you would want to do a comparison between different groups
```{r}
plot(cars)
```
