...
## Divisive clustering 
Divisive clustering does not require a method argument to be specified. let's analyze the data using diana()
...
We can identify observations that falls into similar groups or otherwise by stating the number of groups we want to cut into. let's cut our observation into 5 clusters with the code below. This can be done for both agnes and divise
